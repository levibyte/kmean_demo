...
//FIXME
// FIXME can't be pure virtual because of issue with service.
class LeRenderingControllerImplBase// : public LeService<LeRenderingControllerImplBase>
{
    public:
        ...
        virtual  void on_mouse_move(unsigned int x, unsigned int y){}
        virtual  void on_mouse_click(unsigned int btn) {}
        virtual  void on_key_press(unsigned int btn) {}
        virtual  void on_draw_event() {}
        virtual  void on_update_event(unsigned int) {}
        
        
        virtual  void take_snapshot(bool ) { };
        virtual  int getpixel(int y, int x) { }
        ...
        //shape
        virtual void draw_point(unsigned int y, unsigned int x){ }
