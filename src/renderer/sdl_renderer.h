...
class LeSdlRenderer : public LeRenderingControllerImplBase
{
	...
	void on_mouse_move(unsigned int x, unsigned int y) {}
        void on_mouse_click(unsigned int btn) {}
        void on_key_press(unsigned int btn) {}
        void on_draw_event() {}
        void on_update_event(unsigned int) {}
